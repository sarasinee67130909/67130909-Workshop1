...
CREATE TABLE notifications (
  ...
  product_id INT NULL,  -- ใช้กับ type='new_review' เพื่อ deep-link ไปดูสินค้านั้น
  review_id  INT NULL,  -- ใช้กับ type='new_review' เพื่อเปิดป๊อปอัพแสดงรีวิวใบนั้นโดยตรง
