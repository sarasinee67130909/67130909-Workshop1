...
- สมัครสมาชิก เข้าสู่ระบบ และจัดการข้อมูลส่วนตัว
...
การเชื่อมต่อระบบชำระเงินจริง (Payment Gateway) การส่ง SMS แจ้งเตือนจริง ระบบเปลี่ยน/คืนสินค้า ระบบสมาชิกสะสมแต้ม และการจัดการโปรโมชันขั้นสูง จะไม่พัฒนาในโครงงานนี้ แต่ได้ออกแบบโครงสร้างระบบให้สามารถรองรับการพัฒนาต่อยอดในอนาคต
...
- โมดูลสมาชิก (Member) – สมัครสมาชิก เข้าสู่ระบบ จัดการโปรไฟล์และที่อยู่จัดส่ง
...
- โมดูลรายงานสต็อก (Stock Report) – สินค้าคงเหลือ ใกล้หมด และขายช้า
- โมดูลรายงานผลประกอบการ (Profit Report) – รายรับ ต้นทุน และกำไรขั้นต้น

## **8.4 โมดูลกลางของระบบ**

- โมดูลยืนยันตัวตนและกำหนดสิทธิ์ (Authentication & Authorization) – ควบคุมการเข้าถึงตามบทบาท
- โมดูลจัดการสต็อกอัตโนมัติ (Stock Engine) – ตัดและคืนสต็อกอัตโนมัติเมื่อเกิดคำสั่งซื้อหรือการยกเลิก
- โมดูลแจ้งเตือน (Notification) – แจ้งยืนยันคำสั่งซื้อและการเปลี่ยนสถานะผ่านอีเมล (จำลอง)

# **9\. ขั้นตอนการทำงานของระบบ**

ระบบมีกระบวนการหลักเป็นวงจรคำสั่งซื้อ (Order Lifecycle) ที่เชื่อมโยงผู้ใช้งานทั้ง 3 บทบาท ดังนี้

1.  ลูกค้าเลือกสินค้า ระบุตัวเลือก (ไซซ์/สี/วัสดุ) เลือกบริการห่อของขวัญ และทำการสั่งซื้อพร้อมแนบหลักฐานการชำระเงิน
2.  ระบบบันทึกคำสั่งซื้อ ตัดสต็อกตามตัวเลือกสินค้าที่ถูกซื้อ และแจ้งเตือนคำสั่งซื้อใหม่ไปยังแดชบอร์ดพนักงาน
...
กรณีพิเศษ: หากลูกค้าไม่ชำระเงินภายในระยะเวลาที่กำหนด ระบบจะยกเลิกคำสั่งซื้อและคืนสต็อกโดยอัตโนมัติ
